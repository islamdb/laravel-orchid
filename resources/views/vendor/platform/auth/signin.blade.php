<div class="mb-3">
    ...
    <label class="form-label">
        {{ __(ucfirst(config('fortify.username'))) }}
    </label>

    {!!  \Orchid\Screen\Fields\Input::make(config('fortify.username'))
        ->type(config('fortify.username'))
        ->required()
        ->tabindex(1)
        ->autofocus()
        ->placeholder(__('Enter your ' . config('fortify.username')))
    !!}
</div>
